 ...
 */
export class BranchDataSource extends DataSource<Emirates> {
   ...
   this.sortedData = this.data.getValue();
    ...
    this.sortedData.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        case 'noshows': return compare(a.noShow, b.noShow, isAsc);
        default: return 0;
      }
    });
...
filterWithCriteria(filtercriteria : BranchFilterCriteria): any {
  ...
  this.dataProvider.getQueuesByBranchId(filtercriteria.sort , filtercriteria.branchId)
  .subscribe(res => this.data.next(res));
}
